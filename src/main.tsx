...
function App() {
  ...
  return <main className="shell">
    ...
    <article className="calculator">
      ...
      <details className="references"><summary>Acerca del score y sus fuentes <span aria-hidden="true">+</span></summary><div><h2>Cómo se calcula</h2><p>Se suman los puntos de los siete factores presentes, con un máximo de 13. El tabaquismo no forma parte del sistema de puntuación del documento.</p><h2>Fuente de esta versión</h2><p>ARAGON_FGR_Score.docx, tablas 2, 3 y 4. Los puntos y el ejemplo de 6 puntos se contrastaron con «Score prueba piloto.pdf».</p><h2>Alcance de las estimaciones</h2><p>Los documentos describen una función logística, pero no especifican su intercepto ni una ecuación completa calibrada. Esta calculadora reproduce la tabla de probabilidades, sin reconstruir esa ecuación. El protocolo plantea el desarrollo y la validación interna del modelo; aquí no se afirma una validación completada.</p><p>«Preeclampsia» conserva el nombre del documento. Su definición temporal debe precisarse en el protocolo antes del uso clínico.</p><p>La gráfica de crecimiento es conceptual. Sus curvas y su marcador son ilustrativos, permanecen fijos y no representan mediciones ni percentiles calculados a partir del score.</p><p>Los datos seleccionados permanecen en esta sesión. No se solicitan nombres ni se guardan registros de pacientes.</p><p className="small">{SCORE_VERSION}</p></div></details>
